	...
	return (
		<section className="flex flex-col gap-12 items-center py-5">
			<Image
				...
				priority
			/>
			<p className="w-2/3 text-pretty text-black/70 leading-5 md:leading-7 text-center text-sm md:text-base">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 px-6 md:px-16 gap-4 content-center">
				<Card
					icon={<Cart className="size-12 md:size-24" />}
				...
				/>
				<Card
					icon={<Manufacturing className="size-12 md:size-24" />}
